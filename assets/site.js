...
(function () {
  ...
  var I18N = {
    ...
    odr_h2: { pt: "Nota sobre a antiga plataforma europeia (RLL)", en: "Note on the former EU platform (ODR)" },
    odr_p2: { pt: "A Plataforma Europeia de Resolução de Litígios em Linha, criada pela União Europeia, foi extinta pela Comissão Europeia a 20 de julho de 2025 (Regulamento (UE) 2024/3228) e já não aceita novos casos. A lista atual de entidades de resolução de litígios de consumo nos Estados-Membros está disponível em:", en: "The European Online Dispute Resolution Platform, created by the European Union, was discontinued by the European Commission on 20 July 2025 (Regulation (EU) 2024/3228) and no longer accepts new cases. The current list of consumer dispute-resolution bodies in EU Member States is available at:" },
